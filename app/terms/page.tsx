const Terms = () => {
  ...
  return (
    <div className="flex pt-[10vh] justify-center h-[100%] dark:bg-gray-800">
      <div className="w-[50vw]">
        <h1 className="text-white text-[36px] font-bold">
          TERMS AND CONDITIONS
        </h1>
        <p className="text-gray-400 mt-[30px]">Last updated July 27, 2023</p>
        ...
        <p className="text-white mb-[30px]">
          ...
          "Site"). We are registered in New York, United States and have our
          registered office at 900 5th Ave, New York, NY 10021, USA, New York,
          NY 10021. You agree that by accessing the Site, you have read,
          ...
          these Terms and Conditions from time to time. We will alert you about
          any changes by updating the "Last updated" date of these Terms and
          Conditions, and you waive any right to receive specific notice of each
          ...
          your continued use of the Site after the date such revised Terms and
          Conditions are posted. The information provided on the Site is not
          ...
          the Gramm-Leach-Bliley Act (GLBA). The Site is intended for users who
          ...
          parent or guardian read and agree to these Terms and Conditions prior
        ...
        <p className="text-white mb-[30px]">
          ...
          and Conditions; (4) you are not under the age of 13; (5) you are not a
          ...
          any applicable law or regulation. If you provide any information that
          is untrue, inaccurate, not current, or incomplete, we have the right
          to suspend or terminate your account and refuse any and all current or
          future use of the Site (or any portion thereof).
        </p>
        <h2 className="text-white font-bold mb-[30px]">4. USER REGISTRATION</h2>
        <p className="text-white mb-[30px]">
        ...
        <h2 className="text-white font-bold mb-[30px]">5. FEES AND PAYMENT</h2>
        <p className="text-white mb-[30px]">
          We accept the following forms of payment:
          <ul className="mt-[10px] mb-[10px]">
            <li className="pl-5">Visa</li>
            <li className="pl-5">Mastercard</li>
            <li className="pl-5">Liqpay</li>
          </ul>
        ...
        <h2 className="text-white font-bold mb-[30px]">6. CANCELLATION</h2>
        <p className="text-white mb-[30px]">
          ...
          term. If you are unsatisfied with our services, please email us at
          kolya.sotnichenko0811@gmail.com or call us at (+380)970007552.
        </p>
        <h2 className="text-white font-bold mb-[30px]">
        ...
        <p className="text-white mb-[30px]">
          ...
          Site and/or the Content contained therein. Disparage, tarnish, or
          otherwise harm, in our opinion, us and/or the Site. Use any
          ...
          or services connected to the Site. Harass, annoy, intimidate, or
          threaten any of our employees or agents engaged in providing any
          portion of the Site to you. Attempt to bypass any measures of the Site
          designed to prevent or restrict access to the Site, or any portion of
          the Site. Copy or adapt the Site's software, including but not limited
          ...
          effort to compete with us or otherwise use the Site and/or the Content
        ...
        <p className="text-white mb-[30px]">
          ...
          and warrant that: The creation, distribution, transmission, public
          ...
          contemplated by the Site and these Terms and Conditions. You have the
          ...
          provision of these Terms and Conditions, or any applicable law or
        ...
        <p className="text-white mb-[30px]">
          ...
          more appropriate locations on the Site; and (3) to pre-screen or
        ...
        <h2 className="text-white font-bold mb-[30px]">10. SUBMISSIONS</h2>
        <p className="text-white mb-[30px]">
        ...
        <p className="text-white mb-[30px]">
          ...
          should be aware these Terms and Conditions no longer govern. You
        ...
        <p className="text-white mb-[30px]">
          ...
          services are subject to the terms of these Terms and Conditions in
          ...
          agency within the Department of Defense, our services are subject to
          the terms of these Terms and Conditions in accordance with Defense
          Federal Acquisition Regulation ("DFARS") 227.7202-3. In addition,
          DFARS 252.227-7015 applies to technical data acquired by the DOD. This
          ...
          rights in computer software or technical data under these Terms and
          Conditions.
        </p>
        <h2 className="text-white font-bold mb-[30px]">13. SITE MANAGEMENT</h2>
        <p className="text-white mb-[30px]">
        ...
        <h2 className="text-white font-bold mb-[30px]">14. PRIVACY POLICY</h2>
        <p className="text-white mb-[30px]">
          We care about data privacy and security. Please review our Privacy
          Policy: https://www.site.com/privacy-policy. By using the Site, you
          agree to be bound by our Privacy Policy, which is incorporated into
          these Terms and Conditions. Please be advised the Site is hosted in
          the United States. If you access the Site from any other region of the
        ...
        <p className="text-white mb-[30px]">
          ...
          or discontinuance of the Site. Nothing in these Terms and Conditions
        ...
        <h2 className="text-white font-bold mb-[30px]">18. GOVERNING LAW</h2>
        <p className="text-white mb-[30px]">
        ...
        <h2 className="text-white font-bold mb-[30px]">19. CORRECTIONS</h2>
        <p className="text-white mb-[30px]">
        ...
        <h2 className="text-white font-bold mb-[30px]">20. DISCLAIMER</h2>
        <p className="text-white mb-[30px]">
        ...
        <h2 className="text-white font-bold mb-[30px]">22. INDEMNIFICATION</h2>
        <p className="text-white mb-[30px]">
          ...
          forth in these Terms and Conditions; (5) your violation of the rights
        ...
        <h2 className="text-white font-bold mb-[30px]">23. USER DATA</h2>
        <p className="text-white mb-[30px]">
        ...
        <h2 className="text-white font-bold mb-[30px]">25. MISCELLANEOUS</h2>
        <p className="text-white mb-[30px]">
          ...
          Terms and Conditions is determined to be unlawful, void, or
          ...
          the Site. You agree that these Terms and Conditions will not be
        ...
        <h2 className="text-white font-bold mb-[30px]">26. CONTACT US</h2>
        <p className="text-white mb-[30px]">
          In order to resolve a complaint regarding the Site or to receive
          further information regarding use of the Site, please contact us at:
          Phone: (+380)970007552 kolya.sotnichenko0811@gmail.com
        </p>
      </div>
    </div>
  );
